...
export default function EmployHero() {
  ...
  const seoTitle = "Employment Services";
  const seoDescription =
    "Hire top talent with our expert recruitment and headhunting services. We specialize in executive search, permanent staffing, and workforce solutions.";
  const seoKeywords =
    "recruitment agency, headhunting services, talent acquisition, executive search, staffing solutions, permanent recruitment, hire talent";
  const canonicalUrl = "https://youragency.com/employer-services";
  return (
    <>
      <Helmet>
        ...
        <meta property="og:image" content="/images/employe.png" />
        <meta
          property="og:image:alt"
          content="Recruitment Agency Services - Find Top Talent"
        />

        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content={seoTitle} />
        <meta name="twitter:description" content={seoDescription} />
        <meta name="twitter:image" content="/images/employe.png" />
