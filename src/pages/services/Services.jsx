...
const Services = () => {
  ...
  const industryNames = [
    ...
    t("services.industries.industry3.name"),
    t("services.industries.industry4.name"),
    t("services.industries.industry5.name"),
    t("services.industries.industry6.name"),
    t("services.industries.industry7.name"),
    t("services.industries.industry8.name"),
    t("services.industries.industry9.name"),
    t("services.industries.industry10.name"),
    t("services.industries.industry11.name"),
    t("services.industries.industry12.name"),
  ];

  const jobCategoryNames = [
    t("services.jobCategories.category1.title"),
    t("services.jobCategories.category2.title"),
    t("services.jobCategories.category3.title"),
    t("services.jobCategories.category4.title"),
    t("services.jobCategories.category5.title"),
    t("services.jobCategories.category6.title"),
  ];

  const inDemandJobs = [
    t("services.inDemandPositions.position1.role"),
    t("services.inDemandPositions.position2.role"),
    t("services.inDemandPositions.position3.role"),
    t("services.inDemandPositions.position4.role"),
    t("services.inDemandPositions.position5.role"),
    t("services.inDemandPositions.position6.role"),
    t("services.inDemandPositions.position7.role"),
    t("services.inDemandPositions.position8.role"),
  ];
    ...
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content={
            t("services.hero.description") + " " + t("services.cta.description")
          }
        />
        ...
        <meta
          ...
          content={t("services.hero.description")}
        />
        <meta property="og:type" content="website" />
        <meta property="og:url" content={window.location.href} />
        <meta
          property="og:image"
          content="https://images.unsplash.com/photo-1590402494587-44b71d7772f6?q=80&w=870&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
        />

        <meta name="twitter:card" content="summary_large_image" />
        <meta
          name="twitter:title"
          content={`${t("services.hero.title")} | RabotaNet Recruitment`}
        />
        <meta
        ...
        <script type="application/ld+json">
          {JSON.stringify({
            "@context": "https://schema.org",
            "@type": "ItemList",
            name: "Recruitment Job Categories",
            description:
              "Professional recruitment services for various job categories",
            numberOfItems: jobCategories.length,
            itemListElement: jobCategories.map((category, index) => ({
              "@type": "ListItem",
              position: index + 1,
              item: {
                "@type": "Service",
        ...
        <script type="application/ld+json">
          {JSON.stringify({
            ...
            description: "Recruitment expertise across multiple industries",
            numberOfItems: industries.length,
            itemListElement: industries.slice(0, 6).map((industry, index) => ({
              "@type": "ListItem",
              position: index + 1,
              item: {
                "@type": "Occupation",
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <motion.button
                ...
                className="px-8 py-4 bg-white text-gray-900 font-bold rounded-full hover:bg-gray-100 transition-colors duration-300 shadow-lg cursor-pointer"
